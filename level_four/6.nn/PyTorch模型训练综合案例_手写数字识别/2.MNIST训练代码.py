...
if __name__ == '__main__':
    ...
    train_data = MNISTDataset(r'level_four/6.nn/PyTorch模型训练综合案例_手写数字识别/mnist_images/train')
    test_data = MNISTDataset(r'level_four/6.nn/PyTorch模型训练综合案例_手写数字识别/mnist_images/test')
